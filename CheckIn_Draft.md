...
Based on our Random Forest model, we extracted the feature importances to analyze the top characteristics that increase readmission risk. In our current dataset, they are:
